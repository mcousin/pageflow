...
Pageflow.configure do |config|
  ...
  config.paperclip_s3_default_options.merge!(
    :s3_credentials => {
      :bucket => 'guerziapp',
      :access_key_id => 'AKIAIFZRXDA54VIPB6UQ',
      :secret_access_key => '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',
      :s3_host_name => 's3-eu-west-1.amazonaws.com'
    },
    :s3_host_alias =>'s3-eu-west-1.amazonaws.com/guerziapp',
    :s3_protocol => 'http'
  )
  ...
  config.zencoder_options.merge!(
    :api_key => '5a7eb0e299b4e9fb86c4bea8692d588b',
    :output_bucket => 'guerziapp',
    :s3_host_alias => 's3-eu-west-1.amazonaws.com/guerziapp',
    :s3_protocol => 'http',
